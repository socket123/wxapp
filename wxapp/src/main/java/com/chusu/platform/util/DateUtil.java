...
public class DateUtil extends org.apache.commons.lang.time.DateUtils {
    ...
    public static SimpleDateFormat longHourSdf_mone = new SimpleDateFormat("MM月");
    ...
    public static String getDates(Date d) {
        ...
        return longHourSdf_mone.format(d);
    }
        /**
   ...
   public static  SimpleDateFormat format = new SimpleDateFormat("yyyy-MM-dd HH:mm:ss");
    ...
    public  static Date   sdfd(Integer amout){
        Calendar c = Calendar.getInstance();

        Date now = null;
        //过去三个月
        c.setTime(getCurrentMonthStartTime());
        c.add(Calendar.MONTH, -amout);
        Date m3 = c.getTime();
    ...
    //
    public  static Date   yummone(Integer amout){
        Calendar c = Calendar.getInstance();

        Date now = null;

        c.setTime(getCurrentMonthEndTime());
        c.add(Calendar.MONTH, -amout);
        Date m3 = c.getTime();
        String mon3 = format.format(m3);
