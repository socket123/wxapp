...
//
//        line.addDataPoint(new DataPoint(1, 2.17));
//        line.addDataPoint(new DataPoint(2, 3.81));
//        line.addDataPoint(new DataPoint(3, 2.55));
//        line.addDataPoint(new DataPoint(4, 4.25));
//        line.addDataPoint(new DataPoint(5, 3.56));
//
//        printSums(line);
//        printLine(line);
//        Double y = printEstimate(6,line);
//        System.out.println(y);
     ...
     * @return
     */
    public  static  Double prinstd( int[] arr1 ){

        RegressionLine line = new RegressionLine();
        for(int i = 0 ; i <arr1.length ; i++ ){
            line.addDataPoint(new DataPoint((i+1), arr1[i]));
        }
//        printLine(line);
//        line.addDataPoint(new DataPoint(2, 3.81));
//        line.addDataPoint(new DataPoint(3, 2.55));
...
//        printSums(line);
//        printLine(line);
        Double y = printEstimate(13,line);
        System.out.println(y);
        return  y;
    }
    ...
    * 打印出预估值
    * */
    private static Double printEstimate(double x,RegressionLine line){
        double y = line.getA1()*x+line.getA0();
        y = RegressionLine.round(y, 4);
        System.out.println("预估x="+x+"时，y的值为："+y);
